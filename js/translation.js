...
function toItalian(){
	...
	trTxt("profileID","Sono un programmatore e sviluppatore di siti Web di 26 anni. <br>Vivo in Italia, e parlo Inglese fluentemente.<br>Ho esperienza di sviluppo front-end, back-end, e di applicazioni per computer.");
...
function toEnglish(){
	...
	trTxt("profileID","I am a 26 year old Web Developer and Programmer. <br>I live in Italy, and I speak English fluently.<br>I have experience with front-end and back-end web development, and software development.");
